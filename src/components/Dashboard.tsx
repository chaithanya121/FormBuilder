          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            >
              ...
              <p className="text-gray-400 mb-10">
                All the tools you need to create and manage forms
              </p>
            ...
            <div className="w-full py-16">
              ...
              <p className="text-gray-400 mb-10">
                Jump start your form creation with our professionally-designed
                templates
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 shadow-lg">
                  ...
                  <p className="text-gray-300 italic">
                    "Form Builder Pro transformed how we collect lead
                    information. Our conversion rate increased by 40% in just
                    one month!"
                  </p>
                </div>
                ...
                <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 shadow-lg">
                  ...
                  <p className="text-gray-300 italic">
                    "The event registration templates saved us countless hours.
                    Setting up our conference registration was a breeze."
                  </p>
                </div>
                ...
                <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 shadow-lg">
                  ...
                  <p className="text-gray-300 italic">
                    "The analytics dashboard gives us incredible insights into
                    our customer feedback. It's become an essential tool for our
                    product team."
                  </p>
                </div>
              </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex items-start gap-3 p-3 bg-gray-800/70 rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm text-white">
                  You edited <span className="font-medium">Contact Form</span>
                </p>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
          className="bg-gray-800/50 backdrop-blur-sm p-5 rounded-xl border border-gray-700/50 shadow-lg"
        >
