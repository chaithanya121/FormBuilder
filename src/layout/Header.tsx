...
import { Menu, Sun, Moon , Home, FileText, FilePlus, UserCircle, Settings, LogOut } from "lucide-react";
...
const Header = ({ toggleSidebar }: HeaderProps) => {
  ...
  const [isToggled , setIsToggled] = useState<true | false>(false);

  const toggleTheme = () => {
    setIsDarkMode(!isDarkMode);
    // This is just visual for now, we're not implementing actual dark mode yet
  };
  ...
  return (
    <header className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-30 transition-all duration-300">
      <div className="mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button 
            ...
            className="md:flex hover:bg-gray-100"
          >
        ...
        <div className="flex items-center gap-3">
          ...
          <Button variant="outline" size="sm" className="hidden sm:flex bg-white hover:bg-gray-50">
            Log in
          </Button>
          <Button 
            size="sm" 
